...
#* La solución que yo le he dado a este pequeño gran desafio la encontrarás en el archivo: SolucionProyecto.py pero como siempre te digo, querido alumno: INTENTA HACERLO TU MISMO, pelea con el codigo, ama el codigo, juega con el codigo, mira con cara de enojado al código. Ahí, recien ahí ve a ver mi solución y habrás aprendido mas de lo que imaginas. !!! 